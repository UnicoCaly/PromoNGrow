...
| Former name | **"Formerly trading as PrintCo Direct"** (brand history) | **Ruled 2026-09-13 (Carlos); re-cut 2026-09-25.** The footer now reads "Formerly trading as PrintCo Direct" so it reads as *brand* history and does not contradict the legal-entity line below it. In schema the registered entity moved to **`legalName`: "PrintCo Direct Inc."**, and `alternateName` now carries the variants people actually write — **["PrintCo Direct", "Promo N Grow"]** (theme commits `fca5762`, `8cd14ba`). Use "formerly PrintCo Direct Inc." on About, LinkedIn, and directory descriptions. |
